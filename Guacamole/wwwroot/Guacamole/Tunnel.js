...
Guacamole.HTTPTunnel = function(tunnelURL, crossDomain, extraTunnelHeaders) {
    ...
    this.connect = function(data) {
        ...
        connect_xmlhttprequest.setRequestHeader("Accept", "*/*");
        connect_xmlhttprequest.setRequestHeader('Access-Control-Allow-Credentials', 'true');
        connect_xmlhttprequest.setRequestHeader('Access-Control-Allow-Origin', "*");
        connect_xmlhttprequest.setRequestHeader('Allow-Control-Allow-Methods', "*");
        connect_xmlhttprequest.setRequestHeader('Access-Control-Allow-Headers', "Origin, X-Requested-With, Access-Control-Allow-Headers, Content-Type, Authorization");
        connect_xmlhttprequest.setRequestHeader("Content-Type", "application/json");
